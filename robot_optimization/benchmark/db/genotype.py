...
class Genotype(Base):
    ...
    def init_on_load(self):
        self.body = CPNNWINGenotype(multineat.Genome.Deserialize(self.serialized_body))
...
#     # body: CPNNWINGenotype
#     # brain: CPNNWINGenotype
#     # db_row: DbGenotype = field(init=True, repr=False, default=None)
...
#     #             "db_row",
#     #             DbGenotype(
#     #                 serialized_body=self.body.genotype.Serialize(),
#     #                 serialized_brain=self.brain.genotype.Serialize(),
#     #             ),
#     #         )

#     # @classmethod
#     # def from_database_row(cls, db_row: DbGenotype) -> Self:
#     #     return Genotype(
#     #         body=CPNNWINGenotype(multineat.Genome.Deserialize(db_row.serialized_body)),
#     #         brain=CPNNWINGenotype(
#     #             multineat.Genome.Deserialize(db_row.serialized_brain)
#     #         ),
#     #         db_row=db_row,
#     #     )
